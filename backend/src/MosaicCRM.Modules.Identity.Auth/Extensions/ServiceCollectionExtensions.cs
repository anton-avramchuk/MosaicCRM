...
using MosaicCRM.Modules.Identity.Auth.Services;
using MosaicCRM.Modules.Identity.Auth.Services.Abstractions;
using MosaicCRM.Modules.Identity.Domain;
using MosaicCRM.Modules.Identity.Extensions;

namespace MosaicCRM.Modules.Identity.Auth.Extensions;
...
public static class ServiceCollectionExtensions
{
    public static IServiceCollection AddIdentity<TIdentityContext, TSignInManager, TUser, TRole>(this IServiceCollection services, Action<IdentityOptions> setupAction)
        where TUser :CrmIdentityUser<TRole>
        where TRole : CrmIdentityRole

...
public class IdentityUserStore<TIdentityUser, TIdentityRole, TIdentityContext> :
    ...
    IQueryableUserStore<TIdentityUser> where TIdentityUser : CrmIdentityUser<TIdentityRole> where TIdentityContext : IIdentityDbContext where TIdentityRole : CrmIdentityRole
{
